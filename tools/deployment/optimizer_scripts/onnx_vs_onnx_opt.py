...
def compare_results(results_a, results_b):
  ...
  """
    ...
    results = [['max_rel_diff', max_rel_diff], ['max_abs_diff', max_abs_diff],
               ['mean_rel_diff', mean_rel_diff],
               ['mean_abs_diff', mean_abs_diff],
               ['std_rel_diff', std_rel_diff], ['std_abs_diff', std_abs_diff],
...
if __name__ == '__main__':
    ...
    stats_table = [[
        'Model', 'max_rel_diff', 'max_abs_diff', 'mean_rel_diff',
        'mean_abs_diff', 'std_rel_diff', 'std_abs_diff',
        'acc_with_diff_precision', 'rel_diff_percentiles',
    ...
    if args.plot == 'Y':
        ...
        sample_table = stats_table[1:] if len(
            stats_table) < 6 else stats_table[1:6]
