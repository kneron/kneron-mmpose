...
parser.add_argument(
    ...
    nargs=3,
    help=
    'if you using pth, please use this argument to set up the input size of the model. It should be in \'CH H W\' format, e.g. \'--input-size 3 256 512\'.'
)
parser.add_argument(
    '--no-bn-fusion',
...
if len(args.in_file) <= 4:
    ...
    dummy_input = Variable(
        torch.randn(1, int(args.input_size[0]), int(args.input_size[1]),
